...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    subTitle:
      "The Citadel of Ricks is a society of Ricks and Mortys from various dimensions. The Citadel is run by the Council of Ricks, a group of Ricks who are elected to their positions.",
    date: "Jun 29",
    totalLikes: 1200,
    totalComments: 32,
    isSaved: false,
  ...
  },
  {
    ...
    title: "Pickle Rick",
    subTitle:
      "When you're the smartest man in the universe and have the ability to turn yourself into a pickle, the question becomes why not?",
    date: "Jun 29",
    totalLikes: 1900,
    totalComments: 282,
    isSaved: false,
